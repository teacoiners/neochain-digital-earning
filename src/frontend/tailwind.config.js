...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        display: ['BricolageGrotesque', 'Inter', 'sans-serif'],
        body: ['PlusJakartaSans', 'Inter', 'sans-serif'],
      ...
      colors: {
        ...
        "neon-violet": "oklch(var(--neon-violet) / <alpha-value>)",
        "neon-magenta": "oklch(var(--neon-magenta) / <alpha-value>)",
        chart: {
          1: "oklch(var(--chart-1))",
          2: "oklch(var(--chart-2))",
          3: "oklch(var(--chart-3))",
      ...
      boxShadow: {
        ...
        "neon-cyan": "0 0 20px oklch(0.82 0.18 210 / 0.5), 0 0 40px oklch(0.82 0.18 210 / 0.2)",
